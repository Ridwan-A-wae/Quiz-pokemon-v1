    ...
    <div className="block max-w-5xl p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700  ">
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1">
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <button className={`btn ${selectedButton === 2 ? 'btn-danger' : 'btn-primary'} mx-2`} onClick={() => handleButtonClick(2)}>Horsea</button>
          <button className={`btn ${selectedButton === 3 ? 'btn-danger' : 'btn-primary'} mx-2`} onClick={() => handleButtonClick(3)}>Hypno</button>
          <button className={`btn ${selectedButton === 0 ? 'btn-success' : 'btn-primary'} mx-2`} onClick={() => handleButtonClick(0)}>Pikachu</button>
      ...
      <div style={{width:"100%"}}>
        <Link style={{width:"80%"}} className='btn btn-primary ' to={'/c10'}>Next</Link>
